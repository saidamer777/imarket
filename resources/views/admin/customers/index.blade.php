                                            ...
                                            @isset($customers)
                                                @foreach($customers as $customer)
                                                    <tr>
                                                        ...
                                                        <td>{{$customer->address[0]->region.' - '.$customer->address[0]->neighborhood.' - '.$customer->address[0]->lane.' - '.'البناء : '.$customer->address[0]->building.' - '.'الطابق : '.$customer->address[0]->floor.' - '.'الجهة : '.$customer->address[0]->side}} </td>
