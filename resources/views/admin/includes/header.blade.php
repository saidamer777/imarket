            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <h3 class="brand-text">i_market</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرحبا
                  <span
                      class="user-name text-bold-700">  ادمن  </span>
                 ...
                 <i></i></span>
                    ...
                    <li class="dropdown dropdown-notification nav-item order">
                        <a class="nav-link nav-link-label" href="{{route('admin.notifications')}}">
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow my-order" data-count="{{\App\Models\Notification::where(['confirmed'=>0])->get()->count()}}">{{\App\Models\Notification::where(['confirmed'=>0])->get()->count()}}</span>
                            <i class="ficon ft-shopping-cart"> </i></a>
                    </li>

                    <li class="dropdown dropdown-notificationa nav-item wholesales_order">
                        <a class="nav-link nav-link-label" href="{{route('admin.wholesales_notifications')}}">
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow my-order-wholesales" data-count="{{\App\Models\Wholesales_Notification::where(['confirmed'=>0])->get()->count()}}">{{\App\Models\Wholesales_Notification::where(['confirmed'=>0])->get()->count()}}</span>
                            <i class="ficon ft-calendar"> </i></a>
                    </li>
                </ul>
            </div>
        </div>
