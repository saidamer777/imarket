                                            ...
                                            @foreach($notifications as $notification)
                                                <table
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$id=$notification->bill_id}}</td>

                                                        <td>{{$customer_name=\App\Models\Customer::find(\App\Models\Bills::find($id)->customer_id)->name}}</td>
                                                        <td>{{$phone=\App\Models\Customer::find(\App\Models\Bills::find($id)->customer_id)->phone_number}}</td>
                                                ...
                                                <table
                                                    ...
                                                    @foreach(\App\Models\Bills::find($id)->productsOrder as $product)
                                                        <tr>
                                                            <td>{{$product->name}}</td>
