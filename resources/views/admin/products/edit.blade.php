                                        ...
                                        <form class="form" action="{{route('admin.products.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> السعر بالجملة </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$product->count}}" id="count"
                                                                   class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$product->profit}}" id="profit"
                                                                   class="form-control"
                                                                   placeholder="ادخل السعر "
                                                                   name="profit">
                                                            @error('profit')
...
{{--                                                    <div class="col-md-6">--}}
{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="projectinput1"> السعر للمستخدم </label>--}}
{{--                                                            <input type="text" value="{{$product->total_price}}" id="total_price"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   placeholder="ادخل العدد "--}}
{{--                                                                   name="total_price">--}}
{{--                                                            @error('total_price')--}}
