                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" style="font-family:'Cairo', sans-serif"> إضافة
                                        صورة
                                    </li>
                                </ol>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form"
                                            style="font-family:'Cairo', sans-serif ;color: #0A72E8"> إضافة صورة
                                            لمنتج {{\App\Models\Wholesales::find($id)->name}} </h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form class="form" action="{{route('admin.wholesales_products.store_image',$id)}}"
                                                  method="POST"
