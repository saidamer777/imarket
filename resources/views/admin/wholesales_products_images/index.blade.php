                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2">
                        ...
                        <h3 class="content-header-title" style="font-family:'Cairo', sans-serif"> صور منتج
                            {{\App\Models\Wholesales::find($id)->name}} </h3>
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" style="font-family:'Cairo', sans-serif"> صور
                                        منتج ال{{\App\Models\Wholesales::find($id)->name}}
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title" style="font-family:'Cairo', sans-serif"> جميع صور منتج
                                            ال{{\App\Models\Wholesales::find($id)->name}}</h3>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body card-dashboard">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{route('admin.wholesales_products.edit_image',$image->id)}}"
                                                                       class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>
                                                                    <a href="{{route('admin.wholesales_products.delete_image',$image->id)}}"
                                            ...
                                            <div class="justify-content d-flex">
                                                <div class="btn-group" role="group"
                                                     aria-label="Basic example">
                                                    <a href="{{route('admin.wholesales_products.addimage',$id)}}"
