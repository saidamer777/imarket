...
<script>
    ...
    var notificationWrapper =$('.order');
    var notificationToggle =notificationWrapper.find('a[data-toggle]');
    var notificationCountElement =notificationToggle.find('span[data-count]');
    var notificationCount =parseInt(notificationCountElement.data('count'));

    var notificationWrapper1 =$('.wholesales_order');
    var notificationToggle1 =notificationWrapper1.find('a[data-toggle]');
    var notificationCountElement1 =notificationToggle1.find('span[data-count]');
    var notificationCount1 =parseInt(notificationCountElement1.data('count'));


    var channel=pusher.subscribe('confirmation');
    channel.bind('App\\Events\\Confirmation',function (data){

        notificationCount+=1;
        notificationCountElement.attr('data-count',notificationCount);
        notificationWrapper.find('.my-order').text(notificationCount.toString());
    ...
    var channel2=pusher.subscribe('wholesaler_confirmation');
    channel2.bind('App\\Events\\WholesalerOrder',function (data){

        notificationCount1+=1;
        notificationCountElement1.attr('data-count',notificationCount1);
        notificationWrapper1.find('.my-order-wholesales').text(notificationCount1.toString());
